		...
		private async void Search() {
			...
			if (string.IsNullOrEmpty(Link)) {
				...
				try {
					...
					else if (Link.ToLower().Contains("mangafox.me")) Manga = await MangafoxGetInfo.Get(Link);
					...
					else if (Link.ToLower().Contains("webtoons")) Manga = await WebtoonsGetInfo.Get(Link);
